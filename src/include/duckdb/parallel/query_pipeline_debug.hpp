...
struct QueryPipelineDebugEventSnapshot {
	...
	double historical_throughput_mean = 0;
	double historical_throughput_ewma = 0;
	bool lifecycle_tail_valid = false;
	string lifecycle_tail_level;
	idx_t lifecycle_tail_sample_count = 0;
	double lifecycle_tail_mean_ns = 0;
	double lifecycle_tail_p50_ns = 0;
	double lifecycle_tail_p90_ns = 0;
