...
static const ConfigurationOption internal_options[] = {
    ...
    DUCKDB_LOCAL(EnergyAttributionBasePowerPathSetting),
    DUCKDB_LOCAL(EnergyAttributionClosedSegmentsExportEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionCounterProfileSetting),
    DUCKDB_LOCAL(EnergyAttributionDebugExportEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionExportEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionFailPolicySetting),
    DUCKDB_LOCAL(EnergyAttributionLifecyclePhasesEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionMetadataCacheEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionMigrationCheckEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionOutputDirSetting),
    DUCKDB_LOCAL(EnergyAttributionOverheadDetailEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionPerfCountersEnableSetting),
    DUCKDB_LOCAL(EnergyAttributionPeriodMsSetting),
    DUCKDB_LOCAL(EnergyAttributionPeriodicEnableSetting),
    ...
    DUCKDB_GLOBAL(QuerySchedulerPolicySetting),
    DUCKDB_GLOBAL(QuerySLASchedulerEpochMsSetting),
	DUCKDB_GLOBAL(QuerySLAResidualPolicySetting),
	DUCKDB_GLOBAL(QuerySLAEnergyHardwareControlEnableSetting),
	DUCKDB_GLOBAL(QuerySLAEnergyLambdaSetting),
	DUCKDB_GLOBAL(QuerySLAEnergyExplorationEnableSetting),
	DUCKDB_GLOBAL(QuerySLAEnergyExplorationSeedSetting),
	DUCKDB_GLOBAL(QuerySLAEnergyPowerModelPathSetting),
    DUCKDB_LOCAL(StrideUserPrioritySetting),
...
static const ConfigurationAlias setting_aliases[] = {DUCKDB_SETTING_ALIAS("memory_limit", 116),
                                                     DUCKDB_SETTING_ALIAS("null_order", 43),
                                                     DUCKDB_SETTING_ALIAS("profiling_output", 135),
                                                     DUCKDB_SETTING_ALIAS("user", 150),
